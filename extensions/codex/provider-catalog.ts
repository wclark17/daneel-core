...
export const FALLBACK_CODEX_MODELS = [
  {
    ...
    model: "gpt-5.5",
    displayName: "gpt-5.5",
    description: "Latest proven frontier agentic coding model.",
    isDefault: true,
  ...
  },
  {
    ...
    description: "GPT-5.6 high-capability Codex model.",
    inputModalities: ["text", "image"],
    supportedReasoningEfforts: ["low", "medium", "high", "xhigh"],
  },
  {
    ...
    description: "GPT-5.6 balanced Codex model.",
    inputModalities: ["text", "image"],
    supportedReasoningEfforts: ["low", "medium", "high", "xhigh"],
  },
  {
    ...
    description: "GPT-5.6 efficient Codex model.",
    inputModalities: ["text", "image"],
    supportedReasoningEfforts: ["low", "medium", "high", "xhigh"],
  },
  {
