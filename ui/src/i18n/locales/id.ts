...
export const id: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Di seluler? Salin URL lengkap (termasuk #token=...) dari daneel-core dashboard --no-open di desktop Anda.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — autentikasi ulang dengan daneel-core models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Tempel token dari daneel-core dashboard --no-open atau masukkan kata sandi yang dikonfigurasi.",
        stepGenerate:
          "Jika belum ada token yang dikonfigurasi, jalankan daneel-core doctor --generate-gateway-token di host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Jalankan daneel-core dashboard --no-open lalu buka URL baru atau tempel tokennya.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Jalankan daneel-core devices list di host Gateway.",
        stepApproveId: "Setujui permintaan ini: daneel-core devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Buka kembali dashboard yang disajikan dengan daneel-core dashboard agar UI dan Gateway berasal dari instalasi yang sama.",
        stepDevUi:
          "Jika menggunakan pnpm ui:dev, bangun ulang atau mulai ulang UI dev terhadap checkout saat ini.",
        stepRestart:
          "Mulai ulang Gateway setelah memperbarui Daneel Core agar menyajikan protokol saat ini.",
      },
      network: {
        ...
        stepGateway:
          "Pastikan Gateway berjalan dengan daneel-core status atau daneel-core gateway run.",
        stepUrl:
          "Periksa URL WebSocket dan gunakan wss:// saat Gateway berada di belakang HTTPS/Tailscale Serve.",
        stepDashboard:
          "Buka kembali dashboard dengan daneel-core dashboard --no-open untuk menyalin ulang URL dan detail auth saat ini.",
      },
    },
  },
  chat: {
