...
export const vi: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Đang dùng di động? Sao chép URL đầy đủ (bao gồm #token=...) từ daneel-core dashboard --no-open trên máy tính của bạn.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — xác thực lại bằng daneel-core models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Dán token từ daneel-core dashboard --no-open hoặc nhập mật khẩu đã cấu hình.",
        stepGenerate:
          "Nếu chưa cấu hình token, hãy chạy daneel-core doctor --generate-gateway-token trên máy chủ Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Chạy daneel-core dashboard --no-open rồi mở URL mới hoặc dán token của nó.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Chạy daneel-core devices list trên máy chủ Gateway.",
        stepApproveId: "Phê duyệt yêu cầu này: daneel-core devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Mở lại dashboard được phục vụ bằng daneel-core dashboard để UI và Gateway đến từ cùng một bản cài đặt.",
        stepDevUi:
          "Nếu dùng pnpm ui:dev, hãy build lại hoặc khởi động lại UI dev theo checkout hiện tại.",
        stepRestart:
          "Khởi động lại Gateway sau khi cập nhật Daneel Core để nó phục vụ giao thức hiện tại.",
      },
      network: {
        ...
        stepGateway:
          "Xác nhận Gateway đang chạy bằng daneel-core status hoặc daneel-core gateway run.",
        stepUrl: "Kiểm tra WebSocket URL và dùng wss:// khi Gateway nằm sau HTTPS/Tailscale Serve.",
        stepDashboard:
          "Mở lại dashboard bằng daneel-core dashboard --no-open để sao chép lại URL và chi tiết auth hiện tại.",
      },
    },
  },
  chat: {
